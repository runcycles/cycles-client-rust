...
| `ErrorCode`            | `ErrorCode`            | All 16 spec values (through v0.1.25.13) + `Unknown` fallback                                     | PASS   |
