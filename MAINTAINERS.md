...
This document lists the people responsible for triaging issues, reviewing PRs, and cutting releases for `cycles-client-rust` (the Cycles client crate for Rust agents on crates.io).
...
| Release cuts | Project lead | crates.io publish on tag |
| Dependency updates | Dependabot + project lead | Auto-merge on patch updates passing CI + cargo-audit; manual review on minor/major |
...
- **General questions / bug reports**: [GitHub Issues](https://github.com/runcycles/cycles-client-rust/issues)
